 ...
 * 根据交通方式获取样式配置
 */
export function getPolylineStyle(transportMode?: TransportMode): PolylineStyleConfig {
  if (!transportMode) {
    return DEFAULT_POLYLINE_STYLE;
  }
  return TRANSPORT_MODE_STYLES[transportMode] || DEFAULT_POLYLINE_STYLE;
}
